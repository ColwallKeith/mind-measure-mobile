...
export function HelpPage({
  ...
  localSupport = [
    {
      organisation: 'University of Worcester Counselling Service',
      description: 'Free confidential counselling for all University of Worcester students',
      availability: 'Mon-Fri 9am-5pm',
      website: 'https://worcester.ac.uk/counselling'
    },
    {
      organisation: 'University of Worcester Student Support',
      description: '24/7 emergency support line for Worcester students',
      phone: '01905 855000'
    },
    {
      organisation: 'Worcester Mental Health Services',
