  ...
  return (
    <div className="px-6 py-8 space-y-6">
      ...
      <div className="pt-8">
        ...
        <h1 className="text-gray-900 text-center mb-2">Your Profile</h1>
      ...
      <Card className="border-0 shadow-lg backdrop-blur-xl bg-gradient-to-br from-blue-50/80 to-purple-50/80 p-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-gray-900 mb-1">{userData.firstName} {userData.lastName}</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="border-0 shadow-lg backdrop-blur-xl bg-gradient-to-br from-green-50/80 to-blue-50/80 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-900">{wellnessStats.currentStreak}</div>
            ...
            <Card className="border-0 shadow-lg backdrop-blur-xl bg-gradient-to-br from-blue-50/80 to-purple-50/80 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-blue-900">{wellnessStats.averageScore}</div>
          ...
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-white/70 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-gray-900">Your Top Wellness Themes</h3>
            </div>
          ...
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-white/70 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-gray-900">Mood Trend</h3>
              </div>
          ...
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-gradient-to-br from-purple-50/80 to-pink-50/80 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-purple-900">AI Wellness Report</h3>
              </div>
      ...
      {activeTab === 'wellness' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="border-0 shadow-lg backdrop-blur-xl bg-blue-50/70 p-4">
              <div className="text-center">
                <div className="text-xl font-bold text-blue-900">{wellnessStats.currentStreak}</div>
            ...
            <Card className="border-0 shadow-lg backdrop-blur-xl bg-green-50/70 p-4">
              <div className="text-center">
                <div className="text-xl font-bold text-green-900">{wellnessStats.longestStreak}</div>
            ...
            <Card className="border-0 shadow-lg backdrop-blur-xl bg-purple-50/70 p-4">
              <div className="text-center">
                <div className="text-xl font-bold text-purple-900">{wellnessStats.totalCheckIns}</div>
            ...
            <Card className={`border-0 shadow-lg backdrop-blur-xl bg-gradient-to-br ${getScoreColor(wellnessStats.averageScore)}/20 p-4`}>
              <div className="text-center">
                <div className="text-xl font-bold text-gray-900">{wellnessStats.averageScore}</div>
          ...
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-white/70 p-6">
            <h3 className="text-gray-900 mb-4">Your Wellbeing Metrics</h3>
                      ...
                      return (
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50/60 rounded-lg">
                          ...
                          <div className="text-right">
                            <div className="text-gray-900 font-medium">{metric.value}</div>
          ...
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-green-50/70 p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-green-900 mb-2">This is YOUR Data</h4>
        ...
        <div className="space-y-6">
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-white/70 p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-gray-900">Institutional Information</h3>
              <Button
                variant="outline"
                size="sm"
          ...
          <Card className="border-0 shadow-lg backdrop-blur-xl bg-blue-50/70 p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-blue-900 mb-2">How we use your information</h4>
