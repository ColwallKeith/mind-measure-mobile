  ...
  return (
    <div className="px-6 py-8 space-y-8">
      ...
      <div className="text-center space-y-4">
        <Button className="w-full h-16 bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 border-0 shadow-2xl text-lg backdrop-blur-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 rounded-2xl">
